...
export default function Welcome({ auth, laravelVersion, phpVersion, status, canResetPassword }) {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-[#182c25] selection:bg-red-500 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    <div className="flex justify-center">
                        <img src="/assets/SWIFT.png" alt="" className="w-32" />
                    </div>

                    <div className="bg-[#263e3e] px-6 py-4 rounded-lg mt-16 min-h-80 w-fit mx-auto flex flex-col justify-center items-center">
                        <form onSubmit={submit} className='w-80'>
                            <h1 className="text-4xl font-bold text-center mt-3 text-gray-100">Login</h1>
                            <p className="italic text-white text-center">Internal Systems</p>
                            <div>
                            ...
                            <div className="flex items-center justify-end mt-4">
                                ...
                                <PrimaryButton className="ml-4 bg-[#1c2c2c]" disabled={processing}>
                                    Log in
                                </PrimaryButton>
                            </div>
                        </form>
                    ...
                    {/* <div className="mt-16">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            <a
                                ...
                                className="scale-100 p-6 bg-white dark:bg-[#263e3e] dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500"
                            >
                                <div>
